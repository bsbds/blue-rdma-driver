...
ssize_t bluerdma_show_gids(struct device *dev, struct device_attribute *attr, char *buf);
ssize_t bluerdma_show_mac(struct device *dev, struct device_attribute *attr, char *buf);
